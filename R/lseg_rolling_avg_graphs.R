...
#source(paste0(nldasdir,"R/Table_Rolling_Averages.R")
...
df.90day.precip <- ggplot() + 
  geom_point(data = table_precip, mapping = aes(x = jday, y = rolling_90day_PRC,color = "1984-2019"),
             size = 0.5, stroke = 0.5, shape = 16, col = "black") +
...
df.90day.precip
ggsave(paste0(outdir,"df.90day.precip_",landseg,".png"))
img_url <- paste0(outurl,"df.90day.precip_",landseg,".png"
