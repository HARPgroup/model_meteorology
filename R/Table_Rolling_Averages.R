...
if (length(argst) < 4) {
  message("Use: Rscript Table_Rolling_Averages.R landseg dataset landseg_ftype model_version_code ")
  message("Ex: Rscript Table_Rolling_Averages.R A51011 1984010100-2020123123 cbp532_landseg cbp-5.3.2 ")
  quit()
}
...
outfile <- paste0(outdir,landseg,"_rollingAVG_PET.csv")
message(paste("Creating", outfile))
write.table(rollingAVG_PET,outfile,
